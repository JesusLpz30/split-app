...
import SavingsList from '../components/Savings/SavingsList'; // New import for SavingsList
import InvestmentList from '../components/Investments/InvestmentList'; // New import for InvestmentList
                ...
                <GroupProvider>
                    <Routes>
                        ...
                        <Route path="/*" element={<ProtectedRoute />}>
                            ...
                            <Route path="savings" element={<SavingsList />} /> {/* New route for Savings */}
                            <Route path="investments" element={<InvestmentList />} /> {/* New route for Investments */}
